...
- Restore all three Marketplace preview images with stable HTTPS URLs.
...
- Ship the bilingual Marketplace README and initial product screenshots inside the VSIX.
